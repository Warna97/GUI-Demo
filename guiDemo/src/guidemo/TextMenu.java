...
public class TextMenu extends JMenu {
	...
	// New instance variable for the "Left" radio button
	...
	public TextMenu(DrawPanel owner) {
		...
		// Add a new submenu for text justification
        add(makeJustifyMenu());
	}
	...
	private JMenu makeJustifyMenu() {
	    ...
	    // Create the "Right" radio button
	    JRadioButtonMenuItem rightJustify = new JRadioButtonMenuItem("Right");
	    ...
	    // Create the "Center" radio button
	    JRadioButtonMenuItem centerJustify = new JRadioButtonMenuItem("Center");
	    ...
	    // Select the "Left" radio button by default
	...
	private void setLineHeight() {
	    ...
	    String newLineHeight = JOptionPane.showInputDialog(panel, "Enter Line Height Multiplier:", currentLineHeight);

	    if (newLineHeight != null && newLineHeight.trim().length() > 0) {
	        try {
	            double multiplier = Double.parseDouble(newLineHeight.trim());
	            panel.getTextItem().setLineHeightMultiplier(multiplier);
	            panel.repaint();
	        } catch (NumberFormatException e) {
	            JOptionPane.showMessageDialog(panel, newLineHeight + " is not a valid line height multiplier.\n"
	...
	public void setDefaults() {
	    ...
	    leftJustify.setSelected(true);
	 // Reset Line Height to default value
	    panel.getTextItem().setLineHeightMultiplier(1.0);
	}
