...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/sunset.jpeg"));
		...
		try { // I'd like to use the Desktop folder as the initial folder in the file chooser.
		 ...
		 // Add an icon toolbar to the SOUTH position of the layout
        IconSupport iconSupport1 = new IconSupport(drawPanel);
        content.add(iconSupport1.createToolbar(true), BorderLayout.SOUTH);

        // Create the menu bar and add it to the frame. The TextMenu is defined by
        // a separate class. The other menus are created in this class.
        JMenuBar menuBar1 = new JMenuBar();
        menuBar1.add(makeFileMenu());
        textMenu = new TextMenu(drawPanel);
        menuBar1.add(textMenu);
        
        // Use the createMenu() method to create the menu and add it to the menu bar.
        menuBar1.add(iconSupport1.createMenu());

        menuBar1.add(makeBackgroundMenu());
    ...
    private class ChooseBackgroundAction extends AbstractAction {
        ...
        private ImageIcon createColorIcon() {
            ...
            // Fill a smaller square with light gray
    ...
    private JToolBar makeToolbar() {
        ...
        // Add ChooseBackgroundAction objects to the toolbar
